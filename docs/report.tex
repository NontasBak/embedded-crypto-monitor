...
The timeframe is around 7 days, from August 1st to August 7th.
...
The CPU idle percentage is generally above 96\%, while on the edge cases it can drop to 93\%. Generally,
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|r|r|r|r|r|}
        ...
        \hline
        Distance-Based & \$79,476.15 & \$-523.85 & -0.65\% & 44 & 5.5 \\
        \hline
        EMA Crossover & \$79,769.19 & \$-230.81 & -0.29\% & 8 & 1.0 \\
        \hline
        Buy \& Hold & \$75,011.69 & \$-4,988.31 & -6.24\% & 0 & 0.0 \\
        \hline
    \end{tabular}
...
\textbf{EMA Crossover strategy performed the best} with the smallest loss of -0.29\%, 
followed by the Distance-Based strategy at -0.65\%. The passive Buy \& Hold strategy had the worst 
performance with a -6.24\% loss over the 3-day period.
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|r|r|r|}
        ...
        \hline
        BTC-USDT & EMA & \$45.09 & 5 & 0 \\
        \hline
        ADA-USDT & Distance & \$19.70 & 5 & 2 \\
        \hline
        ETH-USDT & EMA & \$59.24 & 5 & 0 \\
        \hline
        DOGE-USDT & EMA & \$122.07 & 5 & 0 \\
        \hline
        XRP-USDT & Distance & \$58.95 & 3 & 2 \\
        \hline
        SOL-USDT & EMA & \$84.38 & 7 & 0 \\
        \hline
        LTC-USDT & EMA & \$112.17 & 9 & 0 \\
        \hline
        BNB-USDT & Distance & \$51.26 & 5 & 4 \\
        \hline
    \end{tabular}
...
\begin{itemize}
    ...
    \item The source code along with the data collected can be found on the \href{https://github.com/NontasBak/embedded-crypto-monitor}{Github repository}.
\end{itemize}
